...
const Contact = () => {
    ...
    return (
        <>
            <section ref={contactRef} className={`contact hidden ${contactInView ? 'slide-in-left' : 'fade-in'}`}>
                <div className="container contact-container">
                    ...
                    <div className="container-tags">
                        <div className={`tag hidden ${contactInView ? 'scale-in-top-two' : 'fade-in'}`}>
                        ...
                        <div className={`tag hidden ${contactInView ? 'scale-in-top-three' : 'fade-in'}`}>
                        ...
                        <div className={`tag hidden ${contactInView ? 'scale-in-top-four' : 'fade-in'}`}>
