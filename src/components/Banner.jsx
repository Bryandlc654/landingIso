...
const Banner = () => {
    ...
    return (
        <>
            <section ref={bannerRef} className="section-banner">
                <div className="container">
                    <div className={`banner hidden ${bannerInView ? 'slide-in-left' : 'fade-in'}`}>
                    ...
                    <div id='video' className={`banner-video hidden ${bannerInView ? 'slide-in-left-two' : 'fade-in'}`}>
                        <video
                            id="video-html"
                        ...
                        {showButton && (
                            <button className="play-pause-btn btn btn_primary" onClick={handlePlayPause}>
                                {isPlaying ? '❚❚' : '▶'}
                            </button>
                        )}
                    </div>
